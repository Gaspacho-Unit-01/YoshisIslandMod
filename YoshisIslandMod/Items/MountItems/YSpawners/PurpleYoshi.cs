...
{
	public class PurpleYoshi : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Purple Yoshi Egg");
		...
		public override void SetDefaults()
		{
			...
			item.noMelee = true;
			item.mountType = mod.MountType("PurpleYoshi");
		}

		public override void AddRecipes()
		{
			ModRecipe recipe = new ModRecipe(mod);
			recipe.AddIngredient(null, "PurpleFruit", 10);
