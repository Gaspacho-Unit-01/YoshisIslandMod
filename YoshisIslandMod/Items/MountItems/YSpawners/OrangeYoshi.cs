...
{
	public class OrangeYoshi : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Orange Yoshi Egg");
		...
		public override void SetDefaults()
		{
			...
			item.noMelee = true;
			item.mountType = mod.MountType("OrangeYoshi");
		}

		public override void AddRecipes()
		{
			ModRecipe recipe = new ModRecipe(mod);
			recipe.AddIngredient(null, "OrangeFruit", 10);
