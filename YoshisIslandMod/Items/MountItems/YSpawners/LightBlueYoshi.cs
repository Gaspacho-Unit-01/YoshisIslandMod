...
{
	public class LightBlueYoshi : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Light Blue Yoshi Egg");
		...
		public override void SetDefaults()
		{
			...
			item.noMelee = true;
			item.mountType = mod.MountType("LightBlueYoshi");
		}

		public override void AddRecipes()
		{
			ModRecipe recipe = new ModRecipe(mod);
			recipe.AddIngredient(null, "LightBlueFruit", 10);
